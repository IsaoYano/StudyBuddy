    ...
    <div className="min-h-screen app-bg flex items-center justify-center">
      ...
      >
        <motion.div
          ...
          className="w-24 h-24 rounded-3xl shadow-md flex items-center justify-center"
